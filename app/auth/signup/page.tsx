...
export default function SignupPage() {
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    else setMessage('Check your email to confirm the new workspace.')
    setLoading(false)
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <form onSubmit={handleSubmit} className="w-full max-w-sm bg-white rounded-2xl shadow-lg p-6">
        ...
        <p className="text-sm text-gray-500 text-center mt-1 mb-6">Use your work email to create a secure account.</p>
