...
for (const marker of ['SecureStore', 'signInWithPassword', 'inspection_photo_queue', 'inspection_photo_queue', 'inspection_sessions', 'inspection_measurements', 'inspection_photos', 'current_workspace_id', 'inspection-photos', 'accessibilityRole="checkbox"']) assert.ok(app.includes(marker), marker)
